...
# from CMGradobject import CMGobject as CMGobject
...
x1 = CMGobject(1, np.array([1, 0, 0, 0]))
x2 = CMGobject(2, np.array([0, 1, 0, 0]))
x3 = CMGobject(3, np.array([0, 0, 1, 0]))
x4 = CMGobject(4, np.array([0, 0, 0, 1]))
